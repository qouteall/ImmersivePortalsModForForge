...
public class MyBuiltChunkStorage extends ViewFrustum {
    ...
    public static class Preset {
        ...
        public void updateNeighbor(
            TriConsumer<ChunkRenderDispatcher.ChunkRender, Direction, ChunkRenderDispatcher.ChunkRender> func
        ) {
            //for optifine
        }
    }
    ...
    private ChunkRenderDispatcher.ChunkRender provideBuiltChunkWithAlignedPos(BlockPos basePos) {
        ...
        return builtChunkMap.computeIfAbsent(
            basePos.toImmutable(),
            whatever -> {
                ChunkRenderDispatcher.ChunkRender builtChunk = factory.new ChunkRender();
