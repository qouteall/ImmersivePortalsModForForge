...
public class MyRenderHelper {
    ...
    public static void updatePreRenderInfo(
        ...
        MyRenderHelper.originalPlayerLastTickPos = Helper.lastTickPosOf(cameraEntity);
    ...
    public static void onTotalRenderEnd() {
        ...
        if (getRenderedPortalNum() != 0) {
            ...
            ((IEWorldRenderer) mc.worldRenderer).getChunkRenderDispatcher().updateChunkPositions(
    ...
    public static void setupCameraTransformation() {
        ...
        ActiveRenderInfo camera = PortalRenderer.mc.gameRenderer.getActiveRenderInfo();
        camera.update(
            PortalRenderer.mc.world,
            (Entity) (PortalRenderer.mc.getRenderViewEntity() == null ? PortalRenderer.mc.player : PortalRenderer.mc.getRenderViewEntity()),
...
//    }
    ...
    public static void myDrawFrameBuffer(
        ...
        bufferBuilder_1.pos(0.0D, (double) float_2, 0.0D).tex(0.0D, 0.0D).color(
            255,
            255,
            255,
            255
        ...
        bufferBuilder_1.pos((double) float_1, 0.0D, 0.0D).tex(
            (double) float_3,
            (double) float_4
        ).color(255, 255, 255, 255).endVertex();
        bufferBuilder_1.pos(0.0D, 0.0D, 0.0D).tex(0.0D, (double) float_4).color(
            255,
            255,
            255,
            255
